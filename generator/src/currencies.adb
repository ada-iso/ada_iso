...
package body Currencies is
   ...
   begin
      ...
      Put_Line (F, "   --  ****");
      Put_Line (F, "");
      Put_Line (F, "   --  ****t* Currencies/ISO.Currency.Country");
      Put_Line (F, "   --  DESCRIPTION");
      ...
      Put_Line (F, "   --  METHODS");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Name");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Code");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Numeric");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Unit");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Symbol");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Is_Fund");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Is_Historic");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Historic_Name");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Historic_Numbers");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Withdraw_Date");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Withdraw_Dates");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Historic_Entities");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Historic_Records");
      Put_Line (F, "   --  * Currencies/ISO.Currencies.Currency/Entities");
      Put_Line (F, "   --  EXAMPLE");
